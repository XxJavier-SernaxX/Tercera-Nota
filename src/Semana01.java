...
public class Semana01 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.print("la cuenta de " + account1.owner + " tiene un balance de " + account1.balance
                + " y esta registrado con el siguiente numero bancario " + account1.accountNumber);
